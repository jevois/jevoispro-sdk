...
int32_t acamera_interrupt_handler()
{
    ...
    if ( irq_mask > 0 ) {
      ...
      if ( ( irq_mask & 1 << ISP_INTERRUPT_EVENT_FRAME_COLLISION ) )
      {
        ...
        acamera_isp_isp_global_interrupt_mask_vector_write( 0, ISP_IRQ_MASK_VECTOR & ~(1<<ISP_INTERRUPT_EVENT_FRAME_COLLISION));
