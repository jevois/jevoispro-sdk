...
#define SENSOR_BOARD_MASTER_CLOCK 37125 /* JEVOIS was 24000 */
#define SENSOR_BUS i2c /* JEVOIS was spi */
#define SENSOR_BUS_ADDR_SHIFT 0
#define SENSOR_CHIP_ID 0x01b2
#define SENSOR_DAY_LIGHT_INTEGRATION_TIME_LIMIT 300
#define SENSOR_DEV_ADDRESS 26 /* JEVOIS: 0x34/2 */
...
#define I2C_CLOCK_DIV 40 /* JEVOIS */
#define I2C_CONTROL_MASK 0 /* JEVOIS */
//JEVOIS #define SPI_CLOCK_DIV 40
//JEVOIS #define SPI_CONTROL_MASK ( RX_NEG_MSK | ( CHAR_LEN_MSK & 24 ) | AUTO_SS_MSK | LSB_MSK )
#endif
