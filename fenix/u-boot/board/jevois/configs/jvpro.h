...
/* Khadas commands */
//JEVOIS #define CONFIG_KHADAS_KBI 1
#undef CONFIG_KHADAS_KBI
#define CONFIG_KHADAS_CFGLOAD 1
#define CONFIG_KHADAS_SCRIPT 1

//JEVOIS #define CONFIG_PCA953X 1
#undef CONFIG_PCA953X
//JEVOIS #define CONFIG_SYS_I2C_PCA953X_ADDR 0x20
//JEVOIS #define CONFIG_SYS_I2C_PCA953X_WIDTH { {0x20, 8} }
//JEVOIS #define CONFIG_CMD_PCA953X 1
//JEVOIS #define CONFIG_CMD_PCA953X_INFO 1
//JEVOIS #define CONFIG_POWER_FUSB302 1
#undef CONFIG_CMD_PCA953X
#undef CONFIG_CMD_PCA953X_INFO
#undef CONFIG_POWER_FUSB302

//JEVOIS #define CONFIG_TCA6408 1
#undef CONFIG_TCA6408

//JEVOIS #ifdef CONFIG_OF_LIBFDT_OVERLAY
//JEVOIS #undef CONFIG_OF_LIBFDT_OVERLAY
//JEVOIS #endif

/* configs for CEC */
#define CONFIG_CEC_OSD_NAME		"JEVOISPRO"
...
#define CONFIG_PREBOOT  \
            "run init_display;"\
            "setenv bootargs ${bootargs} hwver=VIM3.V12;"\
            "run storeargs;"\
...
//JEVOIS #define CONFIG_AML_SPIFC
...
//JEVOIS #define CONFIG_AML_CVBS 1
#endif

//JEVOIS #define CONFIG_AML_LCD    1
//JEVOIS #define CONFIG_AML_LCD_TABLET 1
//JEVOIS #define CONFIG_AML_LCD_EXTERN 1
...
//JEVOIS #define CONFIG_CMD_NET   1
...
#define CONFIG_BOOTDELAY	0 //JEVOIS was 1 //delay 1s
